...
### Solución
 ...
 Escojo de entre 10 españoles a 3 $C_{n=10}^{k=3}={ 10 \choose 3}$ y por cada una de estas elecciones escojo 2 extranjeros entre los  6 $C_{n=6}^{k=2}={6 \choose 2}$ en total ${10 \choose 3}\cdot { 6 \choose 2}=\frac{10!}{3!\cdot (10-3)!}\cdot \frac{6!}{2!\cdot (6-2)!}=`r choose(10,3)*choose(6,2)`.$
